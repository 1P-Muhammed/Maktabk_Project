  ...
  <body>
      ...
      <section class="sidebar">
        ...
        <div class="sidebar-container">
          <div class="sidebar-links">
            ...
            ><a href="#" class="menu-links">Catalog</a
    ...
    <main>
      <section class="pages-section">
        ...
        <p>
          This Privacy Policy describes how Maktabk (the "Site", "we", "us", or
          "our") collects, uses, and discloses your personal information when
          you visit, use our services, or make a purchase from maktabk.com (the
        ...
        <ul>
          <li>
            <strong>Contact details</strong> including your name, address, phone
            number, and email.
          </li>
          <li>
          ...
          <li>
            ...
            password, security questions and other information used for account
            security purposes.
          </li>
        ...
        <p>
          ...
          interaction with the Services ("<strong>Usage Data</strong>"). To do
          this, we may use cookies, pixels and similar technologies
          ("<strong>Cookies</strong>"). Usage Data may include information about
        ...
        <ul>
          <li>
            ...
            fulfill your orders, to send notifications to you related to your
            ...
            shipping, facilitate any returns and exchanges and other features
            and functionalities related to your account.
          </li>
          <li>
          ...
          <li>
            ...
            use your personal information to provide you with customer support
            and improve our Services. This is in our legitimate interests in
            order to be responsive to you, to provide effective services to you,
        ...
        <p>
          ...
          <a href="https://www.shopify.com/legal/cookies" target="_blank"
            >https://www.shopify.com/legal/cookies</a
        ...
        <p>
          ...
          above in <i>"How we Collect and Use your Personal Information"</i> and
          <i>"How we Disclose Personal Information"</i>:
        </p>
        <table>
          <tr>
            <th>Category</th>
        ...
        <p>
          ...
          available to you, please call or email us at rahhacraft@gmail.com or
          contact us at 7-street-elmlalh-elAzizia, minya-elQamah-elSharkia, SHR,
          44755, EG.
        </p>
      </section>
